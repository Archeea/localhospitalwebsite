...
export default function Gallery() {
  ...
  const unsplashImageUrl2 = 'https://images.unsplash.com/photo-1594067603478-4d35f080c9a3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODJ8fGhvc3BpdGFsfGVufDB8fDB8fHww&auto=format&fit=crop&w=700&q=60&q=60';
    ...
    <div>
      ...
      <div className="photo-grid">
        ...
        <div
          ...
          style={{
            backgroundImage: `url('${unsplashImageUrl2}')`,

          }}
          onClick={() => handleImageClick({ url: unsplashImageUrl2 })
        }
